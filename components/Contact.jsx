    ...
    <div id="contact" className="w-full ">
      <div className="max-w-[1240px] m-auto px-2 py-16 w-full ">
        ...
        <div className="grid lg:grid-cols-5 gap-8">
          {/* left */}
          <div className="col-span-3 lg:col-span-2 w-full h-full shadow-xl bg-white shadow-gray-400 rounded-xl p-4">
            <div className="lg:p-4 h-full ">
              ...
              <div>
                <h2 className="py-2">Hari Charan K</h2>
                <p>Artist and Web-Developer</p>
                <p className="py-4">
                  I am available for freelance or full-time positions.You can
                  contact me here
                </p>
              </div>
              <div>
          ...
          <div className="col-span-3 w-full h-auto shadow-xl bg-white shadow-gray-400 rounded-xl lg:p-4">
            <div className="p-4">
              <form
                action="https://getform.io/f/6204c11b-7fe1-4196-ae7a-fe666a9b4d0f"
                method="POST"
        ...
        <div className="flex justify-center py-12">
          <Link href="/">
            <a>
              <div className="rounded-full shadow-lg bg-blue-300 shadow-gray-400 p-4 cursor-pointer hover:scale-110 ease-in duration-300">
